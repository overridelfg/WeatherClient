...
class RecyclerViewDailyAdapter(mContext: Context) : RecyclerView.Adapter<RecyclerViewDailyAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): RecyclerViewDailyAdapter.ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.layout_daily_listitem, parent, false)
        return RecyclerViewDailyAdapter.ViewHolder(view)
    }

    @SuppressLint("SetTextI18n")
    override fun onBindViewHolder(holder: RecyclerViewDailyAdapter.ViewHolder, position: Int) {
